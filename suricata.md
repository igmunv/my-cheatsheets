...
4. Оповещении при обнаружении команды в FTP:
...
5. Регулярное выражение для поиска паттернов в трафике:
...
`sudo suricata-update` - скаичвает и обновляет правила из интернета.
